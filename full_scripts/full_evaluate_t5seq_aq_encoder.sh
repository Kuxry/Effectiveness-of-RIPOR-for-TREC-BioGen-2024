...
#q_collection_paths='["./data2/test_query","./data2/test_query"]'
q_collection_paths='./data2/test_query'

#q_collection_paths='["./data/msmarco-full/TREC_DL_2019/queries_2019/","./data/msmarco-full/TREC_DL_2020/queries_2020/"]'
...
if [ $task = all_aq_pipline ]; then
    ...
    --index_dir=$index_dir \
    --out_dir=$out_dir  \
    --q_collection_paths='["./data2/train_queries"]' \
    --topk=100 \
    --encoder_type=t5seq_pretrain_encoder
...
#evalutation
    ...
    pretrained_path=$model_dir/checkpoint
    out_dir=$model_dir/trec_out_docid_test_"$max_new_token"_top20/
    #generate file
