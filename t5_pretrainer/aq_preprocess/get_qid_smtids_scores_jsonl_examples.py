...
root_dir = "./data3/experiments-full-t5seq-aq/"
original_qid_smtid_rerank_path = os.path.join(root_dir,
                                              f"t5_docid_gen_encoder_0_1/sub_smtid_{max_new_token}_out/qid_smtid_docids_teacher_score.train.json")
self_qid_smtid_rerank_path = os.path.join(root_dir,
                                          f"t5seq_aq_encoder_seq2seq_1/sub_smtid_{max_new_token}_out/qid_smtid_docids_teacher_score.train.json")
out_dir = os.path.join(root_dir, f"t5_docid_gen_encoder_0_1/sub_smtid_train_decay{decay}/")
...
print(
    "average length of smtids per query in self_data = {:.3f}".format(total_smtids / len(self_qid_to_smtid_to_rerank)))
